...
- [1] Implement your project in a `firstname-lastname` branch.
- [1] Create a pull request of `firstname-lastname` against your `main` branch.
- [1] Open the assignment in Canvas and submit your pull request.
